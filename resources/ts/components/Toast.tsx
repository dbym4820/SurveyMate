...
function ToastItem({ toast, index, onClose }: ToastItemProps): JSX.Element {
  useEffect(() => {
    if (toast.duration > 0) {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center gap-3 px-4 py-3 rounded-xl border shadow-lg backdrop-blur-sm ${bgColors[toast.type]} min-w-[300px] max-w-md`}
      >
        {icons[toast.type]}
